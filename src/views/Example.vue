...
<script>
	/*
So the blur will make use of validate's touch() method to say hey the user touched the field and then its also invalid.
*/
	...
	export default {
		...
		methods: {
			submit() {
				// set $dirty flad to true on all fields
				this.$v.$touch();
				if (!this.$v.$invalid) {
